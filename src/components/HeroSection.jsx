...
const HeroSection = () => {
  return (
    <div className='w-full h-[100svh] relative overflow-hidden'>
        <video autoPlay muted loop playsInline className='sm:hidden block w-full h-full object-cover object-top' src="/heroVid.mp4"></video>
        <video autoPlay muted loop playsInline className='sm:block hidden w-full h-full object-cover object-top' src="/heroVidPhn.mp4"></video>
        <div className='w-full flex items-center justify-center flex-col h-screen absolute top-0 left-0'>
            ...
            <p className='sm:text-[3vw] md:text-[2.8vw] lg:text-[2vw] xl:text-[1.8vw] text-[1.2vw] sm:font-semibold font-regular  font-[font1]'>A Brand New Website Is Coming Soon!</p>
        </div>
    </div>
  )
}
